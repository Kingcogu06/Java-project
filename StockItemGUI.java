...
public class StockItemGUI {
    ...
    private void buildGUI() {
        ...
        new String[]{"StockItem", "NavSys", "CarBattery", "CarTyres", "WindscreenWipers"});
        ...
        createBtn.addActionListener(e -> {
            ...
            if (type.equals("NavSys")) {
               item = new NavSys(code, qty, pr);
            } else if (type.equals("CarBattery")) {
             item = new CarBattery(code, qty, pr, 12, 60);
            } else if (type.equals("Tyres")) {
              item = new CarTyres(code, qty, pr, "205/55R16", "Summer");
            } else if (type.equals("WiperBlades")) {
              item = new WindscreenWipers(code, qty, pr, 600, "Ford Focus");
            } else {
              item = new StockItem(code, qty, pr);
            }
              
 

              items.add(item);
              itemSelector.addItem(code + "(" + type + ")");
